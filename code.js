...
const newYearsResolutions = ["one", "two", "three"];
...
// from arrays).
nextNewYearsResolution = newYearsResolutions[0];
...
dogs.forEach((dogName) => console.log("The " + dogName + " barks."));
...
//UPPGIFT 4 - ändrade const från "dogs" till "dogss" då det redan
// finns en const i tidgiare uppgift som heter dogs
...
const doggieWalks = dogss.map((dogName) => {
...
const favoriteFoods = ["pasta", "pizza", "meat"];
...
console.log(doggs.labrador.puppy.name);
...
const products = [
  { pname: "Camera", brand: "Canon", model: "EOS 70D" },
  { pname: "Camera", brand: "Nikon", model: "D3400" },
  { pname: "Camera", brand: "GoPro", model: "Hero 4" },
  { pname: "Drone", brand: "DJI", model: "Phantom" },
  { pname: "Drone", brand: "GoPro", model: "Karma" },
];
...
products.forEach((product) => {
  console.log("name " + product.pname + " brand " + product.brand);
});
